...
CONSTRAINT psocial_projet FOREIGN KEY (id_p) REFERENCES Projet(id) ON DELETE CASCADE
);
CREATE TABLE Projet_techno (
    id_p INT PRIMARY KEY,
    innovation TEXT NOT NULL,
CONSTRAINT ptechno_projet FOREIGN KEY (id_p) REFERENCES Projet(id) ON DELETE CASCADE
);
CREATE TABLE Projet_artis (
    id_p INT PRIMARY KEY,
    medium TEXT NOT NULL,
CONSTRAINT partis_projet FOREIGN KEY (id_p) REFERENCES Projet(id) ON DELETE CASCADE
);
...
CONSTRAINT contrib_projet FOREIGN KEY (projet) REFERENCES Projet(id) ON DELETE CASCADE,
CONSTRAINT contrib FOREIGN KEY (contributeur) REFERENCES Contributeur(id)
);
CREATE TABLE Contrepartie (
    id_c INT PRIMARY KEY,
CONSTRAINT contrib FOREIGN KEY (id_c) REFERENCES Contribution(id) ON DELETE CASCADE
);
...
CONSTRAINT contrepartie FOREIGN KEY (id_c) REFERENCES Contrepartie(id_c) ON DELETE CASCADE,
...
CREATE TABLE Projet_socialONG(
    projet INT,
    ONG INT,
CONSTRAINT cle_ong FOREIGN KEY (ONG) REFERENCES ONG(NEU),
CONSTRAINT cle_projet FOREIGN KEY (projet) REFERENCES Projet_social(id_p) ON DELETE CASCADE,
...
CREATE TABLE Avis(
    ...
    note INT NOT NULL,
    texte TEXT NOT NULL,
CONSTRAINT avis_projet FOREIGN KEY (projet) REFERENCES Projet(id) ON DELETE CASCADE,
...
CREATE TABLE MembreProjet(
    projet INT,
    membre INT,
CONSTRAINT cle_projet FOREIGN KEY (projet) REFERENCES Projet(id) ON DELETE CASCADE,
